...
//  ＋ _FadeMultiplier でフェード(0=消える,1=通常表示)
// ============================================================================
Shader "Universal Render Pipeline/Toon/ToonDitherFade"
{
    Properties
    {
        ...
        // 0 = 完全透明, 1 = 通常表示
        _FadeMultiplier ("フェード倍率", Range(0,1)) = 1
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half ToonLightFactor(float3 posWS, float3 normalWS, float4 shadowCoord)
            {
                ...
                [loop] for (uint i = 0; i < count; i++)
                {
                    ...
                    half ndl = saturate(dot(normalWS, l.direction))
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                half wL, wM, wS;
                ThreeBandWeights(v, _Threshold1, _Threshold2, _Fade1, _Fade2,
                                 wL, wM, wS);
                ...
                // ★ フェードはアルファだけにかける
                half alpha = saturate(_FadeMultiplier);
        ...
        Pass
        {
            ...
            half4 fragOL(Varyings IN) : SV_Target
            {
                ...
                half alpha = _OutlineColor.a * saturate(_FadeMultiplier);
