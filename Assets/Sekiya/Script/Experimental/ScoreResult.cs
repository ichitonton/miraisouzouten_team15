...
public class ScoreResult : MonoBehaviour
{
    ...
    private void ShowResult()
    {
        ...
        {
            if (team.teamId == 0) team.finalScore = FinalResultData.ScoreTeam0;
            else if (team.teamId == 1) team.finalScore = FinalResultData.ScoreTeam1;
            else if (team.teamId == 2) team.finalScore = FinalResultData.ScoreTeam2;
        }
        ...
        for (int i = 0; i < rankingSlots.Count; i++)
        {
            if (i < sortedTeams.Count)
            {
                ...
                Exp_TeamData data = new Exp_TeamData();
