...
public class Exp_TimeManager_s : NetworkBehaviour
{
    ...
    private void FinishGame()
    {
        ...
        // シーン上のゴールを探す
        var goals = FindObjectsByType<GoalScore_Network>(FindObjectsSortMode.None);
    ...
    private void SetScoreClientRpc(float red, float blue, float white)
    {
        ...
        FinalResultData.ScoreTeam0 = red;
        FinalResultData.ScoreTeam1 = blue;
        FinalResultData.ScoreTeam2 = white;
