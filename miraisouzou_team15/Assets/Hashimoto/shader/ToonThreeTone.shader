// ============================================================================
//  URP 3諧調トゥーン + テクスチャ + 影の面積/コントラスト調整 + アウトライン + ShadowCaster
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            CBUFFER_START(UnityPerMaterial)
                ...
                half4 _OutlineColor;   // 保持のみ
                half  _OutlineWidth;   // 保持のみ
                half  _Cutoff;
            CBUFFER_END
        ...
        Pass
        {
            ...
            // ★ここがポイント：ShaderLibrary ではなく Shaders 配下
            #include "Packages/com.unity.render-pipelines.universal/Shaders/ShadowCasterPass.hlsl"

            // ShadowCaster が参照する最低限の定義
            TEXTURE2D(_BaseMap);
            SAMPLER(sampler_BaseMap);
            float4 _BaseMap_ST;
            half4  _BaseColor;
        ...
        Pass
        {
            ...
            Varyings vertOL(Attributes IN)
            {
                ...
                Varyings OUT; OUT.positionHCS = vp.positionCS; return OUT;
            }
            half4 fragOL(Varyings IN) : SV_Target { return _OutlineColor; }
            ENDHLSL
        }
    }
